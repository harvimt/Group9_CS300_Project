    ...
    public void nextButtonClicked() {
		...
		try {
			ServiceRendered rendered = new ServiceRendered(
						...
						new Service((Integer) serviceCodeField.getValue()).getFee(),
						new Provider((Integer) providerNumberField.getValue()),
						new Service((Integer) serviceCodeField.getValue()),
						new Member((Integer) memberNumberField.getValue()),
						commentsField.getText()
						/*now,
						(Date) (dateServiceRenderedField.getValue()),
						new Service(Integer.parseInt(serviceCodeField.getText())).getFee(),
						new Provider(Integer.parseInt(providerNumberField.getText())),
						new Service(Integer.parseInt(serviceCodeField.getText())),
