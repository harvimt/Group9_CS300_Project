...
public class ProviderReportUI extends javax.swing.JFrame {
	...
	static private class ProviderReportListModel extends AbstractListModel {
		...
		public Object getElementAt(int index) {
			return report_data.get(index).provider.getProviderName();
		}
		
	}

	static private class ProviderReportTableModel extends AbstractTableModel {
		...
		public Object getValueAt(int rowIndex, int columnIndex) {
			...
			switch(columnIndex){
				...
				case 1:
					return row.getFee();
				case 2:
					return row.getMember().getFullName();
				case 3:
	...
	private ProviderReportListModel list_model;
	private ProviderReportTableModel table_model;
	...
	private void initModels(){
		list_model = new ProviderReportListModel();
		table_model = new ProviderReportTableModel();
	...
	private void jList1ValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_jList1ValueChanged
		...
		ProviderReport.ReportItem item = report.getReportData().get(row);
		
		nameLabel.setText(item.provider.getProviderName());
	...
	private void resetTable(){
		...
		nameLabel.setText("No Provider Selected");
