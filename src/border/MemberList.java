...
public class MemberList extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application
				...
				.getContext().getResourceMap(MemberList.class);
		...
		jTable1.setModel(new javax.swing.table.DefaultTableModel(
				new Object[][] {
						{ "John Smith", "123456789", "Active",
								"123 N Smith Dr", "Smithonia", "OR", "12345" },
						{ "Jane Smith", "987654321", "Active",
								"123 N Smith Dr", "Smithonia", "OR", "12345" },
						...
						{ null, null, null, null, null, null, null },
						{ null, null, null, null, null, null, null } },
				new String[] { "Name", "Number", "Status", "Street", "City",
						"State", "Zip" }));
		...
		jTable1.getColumnModel()
				.getColumn(4)
				.setHeaderValue(
						resourceMap.getString("jTable1.columnModel.title4")); // NOI18N
		jTable1.getColumnModel()
				.getColumn(5)
				.setHeaderValue(
						resourceMap.getString("jTable1.columnModel.title5")); // NOI18N
		jTable1.getColumnModel()
				.getColumn(6)
				.setHeaderValue(
						resourceMap.getString("jTable1.columnModel.title6")); // NOI18N
		...
		layout.setHorizontalGroup(layout
				...
				.addGroup(
						layout.createSequentialGroup().addGap(81, 81, 81)
								.addComponent(jLabel1).addGap(525, 525, 525))
				.addGroup(
